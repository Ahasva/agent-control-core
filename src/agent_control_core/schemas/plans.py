"""
ExecutionPlan = what the agent wants to do
ExecutionPlan is the second step of system's pipeline:
...
class PlanStep(BaseModel):
    """
    `model_config`: LLM cannot invent extra fields, otherwise validation error
    """
    ...
    """
    critical design: structured safety signals
    """
...
class ExecutionPlan(BaseModel):
    """
    ExecutionPlan is generated by LLM (live) or mock function
    Fields explained:
    `summary`: human-readable explanation
    `steps`: list of proposed plan steps, each step describes one action `PlanStep()`
    """
